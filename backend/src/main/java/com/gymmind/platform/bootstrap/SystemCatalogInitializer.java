...
public class SystemCatalogInitializer implements ApplicationRunner {
    ...
    private void initialize() {
        ...
        link(RoleCode.GYM_ADMIN, "booking:write");
        link(RoleCode.GYM_ADMIN, "checkin:write");
        link(RoleCode.GYM_ADMIN, "exercise:read");
        ...
        link(RoleCode.GYM_ADMIN, "workout-record:read");
        link(RoleCode.GYM_ADMIN, "workout-record:write");
        ...
        link(RoleCode.GYM_ADMIN, "knowledge:write");
        link(RoleCode.GYM_ADMIN, "audit:read");
        link(RoleCode.GYM_ADMIN, "ai:report");
        link(RoleCode.GYM_ADMIN, "ai:recommend");
        link(RoleCode.COACH, "knowledge:write");
